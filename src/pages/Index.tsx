          ...
          <div className="flex justify-center items-center mb-4 relative">
            ...
            {isLoggedIn && profile?.id && (
              <button
                ...
                className="absolute left-[calc(100%+4px)] top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground flex items-center justify-center shadow-lg transition-all hover:scale-110"
                title="Ver QR Code"
              >
