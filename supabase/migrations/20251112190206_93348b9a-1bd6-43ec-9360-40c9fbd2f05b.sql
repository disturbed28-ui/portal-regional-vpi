...
DROP TRIGGER IF EXISTS trg_cargo_role_mapping_updated_at ON public.cargo_role_mapping;
...
DROP POLICY IF EXISTS "Todos podem ler cargo_role_mapping" ON public.cargo_role_mapping;
DROP POLICY IF EXISTS "Apenas admins podem modificar cargo_role_mapping" ON public.cargo_role_mapping;
...
DROP POLICY IF EXISTS "Admins podem ver todos os logs de alertas" ON public.alertas_emails_log;
DROP POLICY IF EXISTS "Diretores de divisão podem ver logs da própria divisão" ON public.alertas_emails_log;
DROP POLICY IF EXISTS "Sistema pode inserir logs" ON public.alertas_emails_log;
